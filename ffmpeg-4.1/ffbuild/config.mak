...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64 --target-os=android --arch=x86_64 --cross-prefix=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android- --enable-cross-compile --sysroot=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/platforms/android-21/arch-x86_64/ --pkg-config=/usr/local/bin/pkg-config --pkg-config-flags=--static --enable-pic --enable-small --enable-gpl --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --disable-shared --enable-static --enable-neon --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-postproc --disable-symver --disable-stripping --enable-swscale --disable-network --disable-protocols --enable-protocol=file --enable-protocol=pipe --disable-demuxers --disable-muxers --enable-demuxer='aac,avi,dnxhd,flac,flv,gif,h261,h263,h264,image2,matroska,webm,mov,mp3,mp4,mpeg,ogg,srt,wav,webvtt' --enable-muxer='3gp,dnxhd,flac,flv,gif,image2,matroska,webm,mov,mp3,mp4,mpeg,ogg,opus,srt,wav,webvtt' --disable-encoders --disable-decoders --enable-libx264 --enable-libfdk_aac --enable-encoder='libfdk_aac,mediacodec,h264_mediacodec,h264,flv,h264_videotoolbox,libx264,libx264rgb,mpeg4,msmpeg4v1,msmpeg4v2,msmpeg4,aac,wmav1,wmav2,wavpack,pcm_alaw_at,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_mulaw,pcm_mulaw_at,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,pcm_s64be,pcm_s64le,pcm_s8,pcm_s8_planar,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,pcm_zork' --enable-decoder='h264_mediacodec,8bps,aic,flv,h264,mpeg4,msmpeg4v1,msmpeg4v2,vp7,vp8,vp9,aac,mp3,pcm_alaw,pcm_alaw_at,pcm_bluray,pcm_dvd,pcm_f16le,pcm_f24le,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_lxf,pcm_mulaw,pcm_mulaw_at,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,pcm_s64be,pcm_s64le,pcm_s8,pcm_s8_planar,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,pcm_zork,wavpack,wmav1,wmav2' --disable-filters --enable-filter='fps,scale,aformat,aresample,asetnsamples' --enable-bsf=aac_adtstoasc --disable-debug --disable-doc --extra-cflags='-I$PREFIX/include' --extra-ldflags='-I$PREFIX/lib' --enable-nonfree
...
INTRINSICS=none
EXTERN_PREFIX=
CC=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
CXX=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-g++
AS=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
OBJCC=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
LD=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
DEPCC=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-ar
NM_CMD=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-nm -g
RANLIB=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-ranlib -D
STRIP=echo skipping strip
STRIPTYPE=
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=--sysroot=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/platforms/android-21/arch-x86_64/  --sysroot=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/platforms/android-21/arch-x86_64/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=-fomit-frame-pointer -march=x86-64 -Os -O3 -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/include --sysroot=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/platforms/android-21/arch-x86_64/ -fPIE   -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/include -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread  -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/include -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=-fomit-frame-pointer -march=x86-64 -Os -O3 -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/include --sysroot=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/platforms/android-21/arch-x86_64/ -fPIE   -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/include -fPIC
...
LD_PATH=-L
DLLTOOL=
WINDRES=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-windres
DEPWINDRES=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/toolchains/x86_64-4.9/prebuilt/darwin-x86_64/bin/x86_64-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS=-L/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/lib -fPIE -pie  -I/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/lib  --sysroot=/Users/liuxiaohu/Android_Ndk/android-ndk-r14b/platforms/android-21/arch-x86_64/ -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -L/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/lib -lfdk-aac -lm -L/Users/liuxiaohu/Work/ffmpegbuild/build/x86_64/lib -lx264 -lm -ldl
